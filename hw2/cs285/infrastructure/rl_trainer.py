...
class RL_Trainer(object):
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, all_logs):
        ...
        if self.logmetrics:
            ...
            self.output_logs.append([itr,logs])
            
            if itr == self.params['n_iter']-1:
                with open('./logs/'+ self.params['exp_name'] + '_' + self.params['env_name'] + '.pickle', 'wb') as fp:
                    pickle.dump(self.output_logs, fp)
